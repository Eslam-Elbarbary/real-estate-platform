...
export const myPropertiesCopy = {
  ...
  confirmDeleteDescription: 'هل أنت متأكد من حذف المسودة؟ لا يمكن التراجع',
  confirmArchiveTitle: 'أرشفة الإعلان',
  confirmArchiveDescription: 'سيتم إخفاء العقار من الموقع مع الاحتفاظ بالبيانات',
  confirmRestoreTitle: 'استعادة الإعلان',
  confirmRestoreDescription: 'سيتم إعادة العقار كمسودة',
  ...
  toast: {
    ...
    restored: 'تم استرجاع الإعلان كمسودة',
  },
  empty: {
    ...
    deleted: 'لا توجد إعلانات مؤرشفة',
  ...
  pendingPaymentBadge: 'بانتظار الدفع',
  pendingReviewBadge: 'في انتظار المراجعة',
  continuePayment: 'إكمال الدفع',
  continueResubmit: 'تعديل وإعادة إرسال',
  viewStatus: 'عرض الحالة',
  viewPending: 'عرض الحالة',
  viewStats: 'الإحصائيات',
  renewPlaceholder: 'تجديد الإعلان (قريبًا)',
  editListing: 'تعديل الإعلان',
  lastUpdatedLabel: 'آخر تحديث',
  timelineTitle: 'سجل الحالة',
  nextActionLabel: 'الخطوة التالية',
  paymentPlanLabel: 'الباقة المختارة',
  paymentStatusLabel: 'حالة الدفع',
  paymentPending: 'بانتظار الدفع',
  paymentActive: 'نشطة',
  paymentExpired: 'منتهية',
  paymentCancelled: 'ملغاة',
  noPlanSelected: 'لم تُحدد باقة بعد',
  rejectionReasonTitle: 'سبب الرفض',
  statusPageTitle: 'حالة الإعلان',
  backToMyProperties: 'العودة لعقاراتي',
  summaryTitle: 'ملخص الإعلان',
  loadError: 'تعذر تحميل عقاراتك حاليًا',
  retry: 'إعادة المحاولة',
  actionsUnavailable: 'هذا الإجراء غير متاح حاليًا',
  metrics: {
